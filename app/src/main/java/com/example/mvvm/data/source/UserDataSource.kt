...
interface UserDataSource {
    ...
    suspend fun getAllResearcher(): DataResult<List<Researcher>>
    suspend fun deleteResearcherSupervisor(mail: String): DataResult<Boolean>
    suspend fun getProfileByEmail(email: String): DataResult<ProfileResponse>
}
...
constructor(private val myApi: MyApi) : UserDataSource, BaseDataSource() {
    ...
    override suspend fun getAllResearcher() = returnResult {
        myApi.getAllResearcher()
    }

    override suspend fun deleteResearcherSupervisor(mail: String) = returnIfSuccess {
        myApi.deleteResearchSupervisor(mail)
    }

    override suspend fun getProfileByEmail(email: String) = returnResult {
        myApi.getProfileByEmail(email)
    }
}
